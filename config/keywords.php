...
return [
    ...
    // Thuốc
    'medicine' => [
        'medicine_type_id'  => 'Id loại thuốc',
        'supplier_id'  => 'Id nhà cung cấp',
        'package_number' => 'Số lô',
        'expired_date'  => 'Ngày hết hạn sử dụng',
        'amount' => 'Tổng số lượng khi khởi tạo',
        'imp_source_id'  => 'Id nguồn nhập',
        'imp_time' => 'Thời gian nhập',
        'imp_price' => 'Đơn giá nhập',
        'imp_vat_ratio' => 'Thuế VAT nhập',
        'internal_price' => 'Giá nội bộ',
        'bid_id'  => 'Id thầu',
        'tdl_bid_number'  => 'Số quyết định thầu',
        'tdl_bid_num_order' => 'Số thứ tự của thuốc trong gói thầu',
        'tdl_bid_group_code'  => 'Mã nhóm của thuốc trong gói thầu',
        'tdl_bid_package_code' => 'Mã gói của thuốc trong gói thầu',
        'tdl_bid_year'  => 'Dành cho bệnh viện không quản lý nhập thầu',
        'medicine_register_number'  => 'Số đăng ký ở thời điểm nhập kho',
        'medicine_byt_num_order'  => 'Số thứ tự theo danh mục Bộ y tế tại thời điểm nhập kho (TT40)',
        'medicine_tcy_num_order'  => 'Số thứ tự theo danh mục thuốc chủ yếu tại thời điểm nhập kho',
        'medicine_is_star_mark'  => 'Là thuốc dấu (*) tại thời điểm nhập kho (cv 556)',
        'is_pregnant'  => 'Trường chưa sinh ra (cho thực nhập)',
        'is_sale_equal_imp_price' => 'Trường bán bằng giá nhập (Không quan tâm đối tượng)',
        'tdl_service_id' => 'Id dịch vụ',
        'active_ingr_bhyt_code'  => 'Mã hoạt chất theo quy định BHYT',
        'active_ingr_bhyt_name'  => 'Tên hoạt chất theo quy định BHYT',
        'document_price' => 'Tổng số tiền theo chứng từ nhập',
        'national_name'  => 'Tên quốc gia',
        'manufacturer_id' => 'Id hãng sản xuất',
        'concentra'  => 'Hàm lượng nồng độ',
        'tdl_imp_mest_code'  => 'Mã nhập của phiếu nhập tương ứng',
        'tdl_imp_mest_sub_code' => 'Mã thứ cấp của phiếu nhập tương ứng',
        'imp_unit_amount' => 'Số lượng đơn vị nhập',
        'imp_unit_price'  => 'Giá đơn vị nhập',
        'tdl_imp_unit_id'  => 'Id đơn vị nhập',
        'tdl_imp_unit_convert_ratio'  => 'Tỉ lệ chuyển đổi đơn vị',
        'medical_contract_id' => 'Id hợp đồng dược',
        'contract_price' => 'Giá hợp đồng',
        'profit_ratio'  => 'Tỉ lệ thặng dư khi xuất bán',
        'packing_type_name'  => 'Tên quy cách đóng gói',
        'hein_service_bhyt_name'  => 'Tên BHYT',
        'active_ingr_bhyt_name1'  => 'Tên hoạt chất theo quy định BHYT',
        'medicine_use_form_id'  => 'Id đường dùng thuốc',
        'dosage_form' => 'Dạng bào chế',
        'tax_ratio' => 'VAT xuất báo cáo thuế',
        'tdl_bid_extra_code'  => 'tdl_bid_extra_code',
        'locking_reason'  => 'Lý do khóa',
    ...
    // Loại thuốc
    'medicine_type' => [
        'medicine_type_code'  => 'Mã loại thuốc',
        'medicine_type_name' => 'Tên loại thuốc',
        'service_id' => 'Id dịch vụ',
        'parent_id' => 'Id cha',
        'is_leaf'  => 'Là lá',
        'num_order'  => 'Số ưu tiên',
        ...
        'active_ingr_bhyt_code'  => 'Mã hoạt chất theo quy định BHYT',
        'active_ingr_bhyt_name' => 'Tên hoạt chất theo quy định BHYT',
        'register_number' => 'Số đăng ký (Bộ y tế)',
        'packing_type_id_delete' => 'Id quy cách đóng gói',
        'manufacturer_id'  => 'Id hãng sản xuất',
        'medicine_use_form_id'  => 'Id đường dùng thuốc',
        'medicine_line_id'  => 'Id dòng thuốc',
        'medicine_group_id' => 'Id nhóm thuốc',
        'tdl_service_unit_id'  => 'Id đơn vị tính',
        'tdl_gender_id'  => 'Id giới tính',
        'national_name'  => 'Tên quốc gia',
        'tutorial' => 'HDSD thuốc',
        'imp_price'  => 'Giá nhập',
        'imp_vat_ratio' => 'Thuế VAT nhập',
        'internal_price' => 'Giá nội bộ',
        'alert_max_in_treatment'  => 'Số lượng tối đa có thể kê cho 1 hồ sơ đối tượng',
        'alert_expired_date'  => 'Số ngày giới hạn cảnh báo HSD',
        'alert_min_in_stock'  => 'Số lượng giới hạn tồn kho cảnh báo',
        'alert_max_in_prescription'  => 'Số lượng tối đa trong 1 đơn thuốc',
        'is_stop_imp'  => 'Tạm dừng nhập mới',
        'is_star_mark'  => 'Thuốc dấu (*) theo công văn 556',
        'is_allow_odd'  => 'Cho phép kê lẻ',
        'is_allow_export_odd'  => 'Cho phép (kho) xuất lẻ',
        'is_functional_food'  => 'Là thực phẩm chức năng',
        'is_require_hsd' => 'Bắt buộc có HSD',
        'is_sale_equal_imp_price'  => 'Bán bằng giá nhập (không quan tâm đối tượng)',
        'is_business'  => 'Dành cho nhà thuốc',
        'is_raw_medicine'  => 'Là nguyên liệu bào chế thuốc',
        'is_auto_expend'  => 'Tự động check hao phí khi kê đơn',
        'is_vitamin_a'  => 'Là vitamin A',
        'is_vaccine'  => 'Là vaccine tiêm chủng',
        'is_tcmr'  => 'Áp dụng cho tiêm chủng mở rộng',
        'is_must_prepare' => 'Bắt buộc phải dự trữ theo bệnh nhân (HSDT) khi kê đơn',
        'use_on_day' => 'Số lượng sử dụng trên 1 ngày',
        'description'  => 'Mô tả',
        'mema_group_id' => 'Id mema group',
        'byt_num_order'  => 'Số thứ tự theo thông tư 40 (Bộ y tế)',
        'tcy_num_order'  => 'Số thứ tự theo thông tư 31-12',
        'medicine_type_proprietary_name'  => 'Tên độc quyền',
        'packing_type_name' => 'Tên quy cách đóng gói',
        'rank'  => 'Hạng thuốc (theo quy định của bệnh viện)',
        'medicine_national_code'  => 'Mã thuốc do công dược quốc gia cung cấp',
        'is_kidney' => 'Là thuốc chạy thận',
        'is_chemical_substance'  => 'Là hóa chất',
        'last_exp_price'  => 'Giá bán mới nhất',
        'last_exp_vat_ratio'  => 'VAT bán mới nhất',
        'contraindication'  => 'Chống chỉ định',
        'last_imp_price'  => 'Giá nhập mới nhất',
        'last_imp_vat_ratio'  => 'VAT nhập mới nhất',
        'atc_codes'  => 'Danh sách mã ATC',
        'last_expired_date'  => 'Ngày hết hạn sử dụng của lô mới nhất',
        'recording_transaction'  => 'Định khoản kế toán',
        'is_treatment_day_count'  => 'Có đếm số ngày sử dụng thuốc trong tờ điều trị',
        'allow_missing_pkg_info'  => 'Cho phép nhập thiếu thông tin lô (số lô, HSD)',
        'is_block_max_in_prescription'  => 'Chặn khi kê quá số lượng trên 1 đơn',
        'is_oxygen'  => 'Là oxy',
        'is_split_compensation'  => 'Tách phần bù làm tròn kê lẻ',
        'storage_condition_id'  => 'Id điều kiện bảo quản',
        'contraindication_ids'  => 'Danh sách id chống chỉ định',
        'is_out_hospital'  => 'Thuốc ngoài viện (viện không kinh doanh)',
        'imp_unit_id'  => 'Id đơn vị lúc nhập',
        'imp_unit_convert_ratio'  => 'Tỉ lệ quy đổi từ đơn vị nhập sang đơn vị quản lý',
        'scientific_name' => 'Tên khoa học',
        'preprocessing'  => 'Sơ chế',
        'processing' => 'Phục chế',
        'used_part' => 'Bộ phận sử dụng để điều chế',
        'dosage_form' => 'Dạng bào chế',
        'distributed_amount'  => 'Số lượng được phân bố',
        'is_not_treatment_day_count' => 'Thuốc không áp dụng đánh số ngày sử dụng trong tờ điều trị',
        'is_anaesthesia'  => 'Gây tê',
        'vaccine_type_id'  => 'Id loại vaccine',
        'quality_standards'  => 'Tiêu chuẩn chất lượng',
        'source_medicine' => '1- Thuốc bắc, 2- Thuốc nam',
        'is_drug_store'  => 'Là thuốc thuộc quầy thuốc',
        'locking_reason'  => 'Lý do khóa',
        'preprocessing_code'  => 'Danh sách mã phương pháp sơ chế',
        'processing_code' => 'Danh sách mã phương pháp phục chế',
        'num_order_circulars20' => 'Số thứ tự theo thông tư 20 năm 2022',
        'is_block_max_in_day'  => 'Chặn khi kê quá số lượng trong 1 ngày',
        'alert_max_in_day' => 'Số lượng tối đa trong 1 ngày',
        'htu_id'  => 'Id cách dùng',
        'odd_warning_content'  => 'Nội dung cảnh báo khi kê lẻ',
        'is_original_brand_name' => 'Là thuốc biệt dược',
        'is_generic' => 'Là thuốc tương đương sinh học với biệt dược gốc',
    ...
    // Chỉ số siêu âm
    'suim_index' => [
        'suim_index_code'  => 'Mã chỉ số siêu âm',
        'suim_index_name'  => 'Tên chỉ số siêu âm',
        'suim_index_unit_id' => 'Id đơn vị tính chỉ số siêu âm',
        'num_order' => 'Số ưu tiên',
    ],
    // Chỉ số xét nghiệm
    'test_index' => [
        'test_index_code'  => 'Mã chỉ số xét nghiệm',
        'test_index_name'  => 'Tên chỉ số xét nghiệm',
        'test_service_type_id'  => 'Id dịch vụ',
        'test_index_unit_id'  => 'Id đơn vị tính chỉ số xét nghiệm',
        'num_order' => 'Số ưu tiên',
        'default_value' => 'Giá trị kết quả mặc định',
        'bhyt_code'  => 'Mã BHYT',
        'bhyt_name'  => 'Tên BHYT',
        'is_not_show_service'  => 'Không hiển thị tên dịch vụ trên màn hình kết quả',
        'is_important'  => 'Chỉ số quan trọng',
        'test_index_group_id' => 'Id nhóm chỉ số xét nghiệm',
        'is_to_calculate_egfr'  => 'Chỉ số để tính mức lọc cầu thận',
        'normation_amount'  => 'Số lượng định mức',
        'material_type_id'  => 'Id vật tư sử dụng khi chạy xét nghiệm',
        'is_blood_abo' => 'Chỉ số nhóm máu AOB',
        'is_blood_rh'  => 'Chỉ số nhóm máu RH',
        'is_hbsag'  => 'Chỉ số HbsAg',
        'is_hcv' => 'Chỉ số HCV',
        'is_hiv'  => 'Chỉ số HIV',
        'is_test_harmony_blood'  => 'Là xét nghiệm hòa hợp máu',
        'convert_ratio_mlct'  => 'Tỉ lệ chuyển đổi mức lọc cầu thận',
        'result_blood_a'  => 'Kết quả xét nghiệm tương ứng với nhóm máu A',
        'result_blood_b'  => 'Kết quả xét nghiệm tương ứng với nhóm máu B',
        'result_blood_ab'  => 'Kết quả xét nghiệm tương ứng với nhóm máu AB',
        'result_blood_o'  => 'Kết quả xét nghiệm tương ứng với nhóm máu O',
