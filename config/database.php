...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'oracle_his' => [
            'driver' => 'oracle',
            'host' => env('DB_HOST', '192.168.101.251'),
            'port' => env('DB_PORT', '1521'),
            'database' => env('DB_DATABASE', 'oracletest'),
            'username' => env('DB_USERNAME', 'HIS_RS'),
            'password' => env('DB_PASSWORD', 'HIS_RS'),
        ...
        'oracle_acs' => [
            'driver' => 'oracle',
            'host' => env('DB_DATA_HOST', '192.168.101.251'),
            'port' => env('DB_DATA_PORT', '1521'),
            'database' => env('DB_DATA_DATABASE', 'oracletest'),
            'username' => env('DB_DATA_USERNAME', 'ACS_RS'),
            'password' => env('DB_DATA_PASSWORD', 'ACS_RS'),
            'service_name' => env('DB_DATA_SERVICE_NAME', 'orcl'),
            'charset' => 'AL32UTF8',
            'prefix' => '',
        ],
        'oracle_sda' => [
