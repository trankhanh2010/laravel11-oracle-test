...
return [
    ...
    'db_service' => [
        'error' => [
            ...
            'dhst' => 'Có lỗi khi thực hiện thao tác với bảng Dấu hiệu sinh tồn!',
            ...
            'equipment_set' => 'Có lỗi khi thực hiện thao tác với bảng Bộ vật tư!',
            ...
            'health_exam_rank' => 'Có lỗi khi thực hiện thao tác với bảng Xếp loại khám sức khỏe!',
            ...
            'next_trea_intr' => 'Có lỗi khi thực hiện thao tác với bảng Hướng điều trị tiếp theo!',
            ...
            'transaction_tt_detail_v_view' => 'Có lỗi khi thực hiện thao tác với bảng tạm Chi tiết giao dịch thanh toán!',
            'transaction_tu_detail_v_view' => 'Có lỗi khi thực hiện thao tác với bảng tạm Chi tiết giao dịch tạm thu!',
            'deposit_req_list_v_view' => 'Có lỗi khi thực hiện thao tác với bảng tạm Danh sách yêu cầu tạm ứng!',
            'deposit_req' => 'Có lỗi khi thực hiện thao tác với bảng Yêu cầu tạm ứng!',
