...
class UpdateServSegrIndexJob implements ShouldQueue
{
    use Queueable;
    protected $client;
    protected $record;
    ...
    public function handle(): void
    {
        ...
        switch ($this->tableJoined) {
            case 'service':
                ...
                foreach ($ids as $item) {
                    event(new InsertServSegrIndex($item, 'serv_segr'));
                }
                break;
            case 'service_group':
                $params = [
        ...
        event(new DeleteCache('serv_segr'));
    }
}
