...
class UpdatePatientTypeAllowIndexJob implements ShouldQueue
{
    use Queueable;
    protected $client;
    protected $record;
    ...
    public function handle(): void
    {
        ...
        switch ($this->tableJoined) {
            case 'patient_type':
                ...
                foreach ($ids as $item) {
                    event(new InsertPatientTypeAllowIndex($item, 'patient_type_allow'));
                }
                break;
            case 'patient_type_allow':
                $params = [
                    ...
                    'body'  => [
                        ...
                        'query'   => [
                            'term' => [
                                'patient_type_allow_id' => $record->id
                            ]
                        ]
                    ]
                ];
        ...
        event(new DeleteCache('patient_type_allow'));
    }
}
