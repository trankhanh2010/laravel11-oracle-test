...
class UpdatePtttGroupIndexJob implements ShouldQueue
{
    use Queueable;
    protected $client;
    protected $record;
            ...
            case 'bed_services':
                $params = [
                    ...
                    'body'  => [
                        ...
                        'query'   => [
                            'term' => [
                                'bed_services.pivot.bed_service_type_id' => $record->id
                            ]
                        ]
                    ]
                ];
                ...
                foreach ($ids as $item) {
                    event(new InsertPtttGroupIndex($item, 'pttt_group'));
                }
                break;
            default:
                break;
        }
        event(new DeleteCache('pttt_group'));
    }
}
