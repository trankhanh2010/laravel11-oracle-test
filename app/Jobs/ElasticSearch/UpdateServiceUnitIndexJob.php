...
class UpdateServiceUnitIndexJob implements ShouldQueue
{
    use Queueable;
    protected $client;
    protected $record;
    ...
    public function handle(): void
    {
        ...
        switch ($this->tableJoined) {
            case 'convert':
                ...
                foreach ($ids as $item) {
                    event(new InsertServiceUnitIndex($item, 'service_unit'));
                }
                break;
            default:
                break;
        }
        event(new DeleteCache('service_unit'));
    }
}
