...
class UpdatePtttTableIndexJob implements ShouldQueue
{
    use Queueable;
    protected $client;
    protected $record;
    ...
    public function handle(): void
    {
        ...
        switch ($this->tableJoined) {
            case 'execute_room':
                ...
                foreach ($ids as $item) {
                    event(new InsertPtttTableIndex($item, 'pttt_table'));
                }
                break;
            default:
                break;
        }
        event(new DeleteCache('pttt_table'));
    }
}
