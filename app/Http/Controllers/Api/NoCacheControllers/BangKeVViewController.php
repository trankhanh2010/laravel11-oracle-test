    ...
    public function handleBieuMau()
    {
        ...
        switch ($this->tab) {
            ...
            case 'bangKeNoiTruHaoPhi':
                ...
                break;
            case 'bangKeNoiTruVienPhiTPTB':
                $data = $this->bangKeVViewService->bangKeNoiTruVienPhiTPTB();
                break;
            case 'bangKeNoiTruBHYTTheoKhoa6556QDBYT':
                $data = $this->bangKeVViewService->bangKeNoiTruBHYTTheoKhoa6556QDBYT();
                break;
            case 'bangKeNoiTruVienPhiTheoKhoa6556QDBYT':
            ...
            case 'bangKeTongHop6556KhoaPhongThanhToan':
                ...
                $data['data'][0]['key'] = '';
                $data['count'] = null;
                $data['data'][0]['children'] =  collect($dataChiPhi['data'])->merge($dataHaoPhi['data']);
                break;
