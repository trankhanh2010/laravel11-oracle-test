    ...
    public function patient_case($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->patient_case_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active, $this->time, function () {
                        $data = $this->patient_case
                        ->select(
                            'his_patient_case.*',
                        );
                    ...
                    $data = $this->patient_case->find($id);
                    if ($data == null) {
