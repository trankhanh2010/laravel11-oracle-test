    ...
    public function patient_type_room($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->patient_type_room_name . '_patient_type_id_' . $this->patient_type_id . '_room_id_' . $this->room_id . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active, $this->time, function () {
                        $data = $this->patient_type_room
                        ->leftJoin('his_patient_type as patient_type', 'patient_type.id', '=', 'his_patient_type_room.patient_type_id')
                        ->leftJoin('his_room', 'his_room.id', '=', 'his_patient_type_room.room_id')
                    ...
                    $data = $this->patient_type_room->find($id);
                    if ($data == null) {
