...
class PatientTypeController extends BaseApiCacheController
{
    ...
    public function patient_type($id = null)
    {
        ...
        if ($this->is_active !== null) {
            ...
            if ($id == null) {
                $name = $this->patient_type_name. '_start_' . $this->start . '_limit_' . $this->limit. $this->order_by_tring;
                $param = [
                    'base_patient_type',
                    'other_pay_source'
                ];
            ...
            $data = get_cache_full($this->patient_type, $param, $name, $id, $this->time, $this->start, $this->limit, $this->order_by);
        }
        $param_return = [
            'start' => $this->start,
            'limit' => $this->limit,
