    ...
    public function medicine_line($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->medicine_line_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active, $this->time, function () {
                        $data = $this->medicine_line
                        ->select(
                            'his_medicine_line.*',
                        );
                    ...
                    $data = $this->medicine_line->find($id);
                    if ($data == null) {
