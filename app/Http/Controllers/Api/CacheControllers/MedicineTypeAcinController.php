    ...
    public function medicine_type_acin($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->medicine_type_acin_name .'_medicine_type_id_'.$this->medicine_type_id. '_active_ingredient_id_'.$this->active_ingredient_id. '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active, $this->time, function () {
                        $data = $this->medicine_type_acin
                        ->leftJoin('his_medicine_type as medicine_type', 'medicine_type.id', '=', 'his_medicine_type_acin.medicine_type_id')
                        ->leftJoin('his_active_ingredient as active_ingredient', 'active_ingredient.id', '=', 'his_medicine_type_acin.active_ingredient_id')
                            ->select(
                    ...
                    $data = $this->medicine_type_acin->find($id);
                    if ($data == null) {
