...
class AreaController extends BaseApiCacheController
{
    ...
    public function area($id = null)
    {
        ...
        if ($this->is_active !== null) {
            ...
            if ($id == null) {
                $data = get_cache_full($this->area,[], $this->area_name . '_start_' . $this->start . '_limit_' . $this->limit. $this->order_by_tring. '_is_active_' . $this->is_active. '_get_all_' . $this->get_all, null, $this->time, $this->start, $this->limit, $this->order_by, $this->is_active, $this->get_all);
            } else {
                if (!is_numeric($id)) {
                ...
                $data = get_cache_full($this->area, [], $this->area_name.'_'.$id. '_is_active_' . $this->is_active. '_get_all_' . $this->get_all, $id, $this->time, $this->start, $this->limit, $this->order_by, $this->is_active, $this->get_all);
            }
        }
        $param_return = [
