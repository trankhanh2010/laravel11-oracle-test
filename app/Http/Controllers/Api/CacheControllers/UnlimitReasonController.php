...
class UnlimitReasonController extends BaseApiCacheController
{
    ...
    public function unlimit_reason($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->unlimit_reason_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active. '_get_all_' . $this->get_all, $this->time, function () {
                        $data = $this->unlimit_reason
                        ->select(
                            'his_unlimit_reason.*',
                        );
    ...
    public function unlimit_reason_create(CreateUnlimitReasonRequest $request)
    {
        try {
            $data = $this->unlimit_reason::create([
            ...
            event(new DeleteCache($this->unlimit_reason_name));
