...
class HeinServiceTypeController extends BaseApiCacheController
{
    ...
    public function hein_service_type($id = null)
    {
        ...
        if ($keyword != null) {
            ...
            if ($id == null) {
                $name = $this->hein_service_type_name. '_start_' . $this->start . '_limit_' . $this->limit. $this->order_by_tring;
                $param = [
                ];
            } else {
                if (!is_numeric($id)) {
            ...
            $data = get_cache_full($this->hein_service_type, $param, $name, $id, $this->time, $this->start, $this->limit, $this->order_by);
        }
        $param_return = [
            'start' => $this->start,
            'limit' => $this->limit,
