...
class ContraindicationController extends BaseApiCacheController
{
    ...
    public function contraindication($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->contraindication_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active. '_get_all_' . $this->get_all, $this->time, function () {
                        $data = $this->contraindication
                        ->select(
                            'his_contraindication.*',
                        );
    ...
    public function contraindication_create(CreateContraindicationRequest $request)
    {
        try {
            ...
            event(new DeleteCache($this->contraindication_name));
    ...
    public function contraindication_update(UpdateContraindicationRequest $request, $id)
    {
        if (!is_numeric($id)) {
            return return_id_error($id);
        }
        $data = $this->contraindication->find($id);
        if ($data == null) {
    ...
    public function contraindication_delete(Request $request, $id)
    {
        if (!is_numeric($id)) {
            return return_id_error($id);
        }
