...
class ManufacturerController extends BaseApiCacheController
{
    ...
    public function manufacturer($id = null)
    {
        ...
        try {
            ...
            if ($keyword != null) {
                ...
                if ($id == null) {
                    $data = Cache::remember($this->manufacturer_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring . '_is_active_' . $this->is_active. '_get_all_' . $this->get_all, $this->time, function () {
                        $data = $this->manufacturer
                        ->select(
                            'his_manufacturer.*',
                        );
    ...
    public function manufacturer_create(CreateManufacturerRequest $request)
    {
        try {
            ...
            event(new DeleteCache($this->manufacturer_name));
