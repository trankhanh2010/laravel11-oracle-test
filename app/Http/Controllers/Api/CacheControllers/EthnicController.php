...
class EthnicController extends BaseApiCacheController
{
    public function __construct(Request $request)
    {
        ...
        if ($this->order_by != null) {
            $columns = $this->get_columns_table($this->ethnic);
    ...
    public function ethnic($id = null)
    {
        ...
        if ($this->is_active !== null) {
            ...
            if ($id == null) {
                $name = $this->ethnic_name . '_start_' . $this->start . '_limit_' . $this->limit . $this->order_by_tring. '_is_active_' . $this->is_active. '_get_all_' . $this->get_all;
                $param = [
                ];
            } else {
                if (!is_numeric($id)) {
