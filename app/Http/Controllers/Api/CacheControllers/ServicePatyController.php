...
class ServicePatyController extends BaseApiCacheController
{
    ...
    public function service_paty($id = null)
    {
        ...
        if ($keyword != null) {
            ...
            ->where(DB::connection('oracle_his')->raw('lower(service.service_name)'), 'like', '%' . $keyword . '%')
            ...
            if($id == null){
                ...
                $data = get_cache($this->service_paty, $this->service_paty_name, $id, $this->time, $this->start, $this->limit);
