...
use App\Http\Resources\SereServGetView5Resource;
...
class SereServController extends BaseApiDataController
{
    ...
    public function sere_serv_get(Request $request)
    {
        ...
        $param_return = [
            ...
            $this->service_req_ids_name => $this->service_req_ids,
    ...
    public function sere_serv_get_view_5(Request $request)
    {
        ...
        $select = [
            ...
            "his_sere_serv.SERVICE_REQ_ID",
            "his_sere_serv.PATIENT_TYPE_ID",
            "his_sere_serv.PRIMARY_PATIENT_TYPE_ID",
            "his_sere_serv.PRIMARY_PRICE",
            "his_sere_serv.LIMIT_PRICE",
            "his_sere_serv.HEIN_APPROVAL_ID",
            "his_sere_serv.JSON_PATIENT_TYPE_ALTER",
            "his_sere_serv.AMOUNT",
            "his_sere_serv.PRICE",
            "his_sere_serv.ORIGINAL_PRICE",
            "his_sere_serv.HEIN_PRICE",
            "his_sere_serv.HEIN_RATIO",
            "his_sere_serv.HEIN_LIMIT_PRICE",
            "his_sere_serv.VAT_RATIO",
            "his_sere_serv.IS_SENT_EXT",
            ...
            "his_sere_serv.TDL_SERVICE_CODE",
            "his_sere_serv.TDL_SERVICE_NAME",
            "his_sere_serv.TDL_HEIN_SERVICE_BHYT_CODE",
            "his_sere_serv.TDL_HEIN_SERVICE_BHYT_NAME",
            "his_sere_serv.TDL_SERVICE_TYPE_ID",
            "his_sere_serv.TDL_SERVICE_UNIT_ID",
            "his_sere_serv.TDL_HEIN_SERVICE_TYPE_ID",
            ...
            "his_sere_serv.TDL_SERVICE_REQ_TYPE_ID",
            "his_sere_serv.TDL_HST_BHYT_CODE",
            "his_sere_serv.TDL_PACS_TYPE_CODE",
            "his_sere_serv.VIR_PRICE",
            "his_sere_serv.VIR_PRICE_NO_ADD_PRICE",
            "his_sere_serv.VIR_PRICE_NO_EXPEND",
            "his_sere_serv.VIR_HEIN_PRICE",
            ...
            "his_sere_serv.VIR_TOTAL_PATIENT_PRICE_NO_DC",
            "his_sere_serv.VIR_TOTAL_PATIENT_PRICE_TEMP",
            "his_sere_serv.TDL_REQUEST_USER_TITLE",

            "V_HIS_SERE_SERV_5.SERVICE_TYPE_CODE",
            "V_HIS_SERE_SERV_5.SERVICE_TYPE_NAME",
            "V_HIS_SERE_SERV_5.PATIENT_TYPE_NAME",
            "V_HIS_SERE_SERV_5.SERVICE_UNIT_CODE",
            "V_HIS_SERE_SERV_5.SERVICE_UNIT_NAME",
            "V_HIS_SERE_SERV_5.REQUEST_ROOM_IS_EXAM",
            "V_HIS_SERE_SERV_5.REQUEST_ROOM_CODE",
            "V_HIS_SERE_SERV_5.REQUEST_ROOM_NAME",
            "V_HIS_SERE_SERV_5.SERVICE_REQ_STT_ID",
        ...
        try {
            ...
            if ($this->tdl_treatment_id != null) {
                $data = $data->where(function ($query) {
                    $query = $query->where(DB::connection('oracle_his')->raw('his_sere_serv.tdl_treatment_id'), $this->tdl_treatment_id);
                });
                $data_id = $data_id->where(function ($query) {
                    $query = $query->where(DB::connection('oracle_his')->raw('his_sere_serv.tdl_treatment_id'), $this->tdl_treatment_id);
                });
            ...
            if ($this->sere_serv_id == null) {
                ...
                $fullSql = 'SELECT * FROM (SELECT a.*, ROWNUM rnum FROM (' . $sql . ') a WHERE ROWNUM <= ' . ($this->limit + $this->start) . ' AND ID ' . $this->equal . $this->cursor . $this->sub_order_by_string . ') WHERE rnum > ' . $this->start;
                $data = DB::connection('oracle_his')->select($fullSql, $bindings);
                $data = SereServGetView5Resource::collection($data);
                if (isset($data[0])) {
                    if (($data[0]->id != $this->sere_serv->max('id')) && ($data[0]->id != $this->sere_serv->min('id')) && ($data[0]->id != $id_max_sql) && ($data[0]->id != $id_min_sql)) {
                        $this->prev_cursor = '-' . $data[0]->id;
                    } else {
            ...
            $param_return = [
                ...
                $this->is_include_deleted_name => $this->is_include_deleted ?? false,
                $this->is_active_name => $this->is_active,
                $this->sere_serv_id_name => $this->sere_serv_id,
