...
class SereServDepositController  extends BaseApiDataController
{
    public function __construct(Request $request)
    {
        ...
        if ($this->order_by != null) {
            ...
            //     }
            // }
            $columns = Cache::remember('columns_' . $this->sere_serv_deposit_name, $this->columns_time, function () {
                return  Schema::connection('oracle_his')->getColumnListing($this->sere_serv_deposit->getTable()) ?? [];
