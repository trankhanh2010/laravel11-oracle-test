...
class BaseApiCacheController extends Controller
{
    ...
    protected $materialPatyName = 'material_paty';
    protected $accidentBodyPart;
    protected $accidentBodyPartName = 'accident_body_part';
    protected $emergencyWtime;
    protected $emergencyWtimeName = 'emergency_wtime';
    protected $oweType;
    protected $oweTypeName = 'owe_type';
    protected $bloodAbo;
    protected $bloodAboName = 'blood_abo';
    protected $bloodRh;
    protected $bloodRhName = 'blood_rh';
    ...
    protected $expMestTemplateName = 'exp_mest_template';
    ...
    protected $tranPatiReasonName = 'tran_pati_reason';
    protected $nextTreaIntr;
    protected $nextTreaIntrName = 'next_trea_intr';
    protected $healthExamRank;
    protected $healthExamRankName = 'health_exam_rank';
    ...
    public function __construct(Request $request)
    {
        ...
        $this->serviceGroupIds = $this->paramRequest['ApiData']['ServiceGroupIds'] ?? null;
        if ($this->serviceGroupIds != null) {
            foreach ($this->serviceGroupIds as $key => $item) {
                // Kiểm tra xem ID có tồn tại trong bảng  hay không
                if (!is_numeric($item)) {
