...
class UpdateServicePatyRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'branch_id.required'      => config('keywords')['service_paty']['branch_id'].config('keywords')['error']['required'],
            'branch_id.integer'       => config('keywords')['service_paty']['branch_id'].config('keywords')['error']['integer'],
            'branch_id.exists'        => config('keywords')['service_paty']['branch_id'].config('keywords')['error']['exists'], 

            'patient_type_id.required'      => config('keywords')['service_paty']['patient_type_id'].config('keywords')['error']['required'],
            'patient_type_id.integer'       => config('keywords')['service_paty']['patient_type_id'].config('keywords')['error']['integer'],
            'patient_type_id.exists'        => config('keywords')['service_paty']['patient_type_id'].config('keywords')['error']['exists'], 
