...
class UpdateStorageConditionRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if(!is_numeric($this->storage_condition)){
            throw new HttpResponseException(returnIdError($this->storage_condition));
        }
        return [
            'storage_condition_code' =>        [
                                                    ...
                                                    'string',
                                                    'max:10',
                                                    Rule::unique('App\Models\HIS\StorageCondition')->ignore($this->storage_condition),
                                                ],
