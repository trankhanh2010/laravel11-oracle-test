...
class CreateLocationTreatmentRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'location_store_code' =>      'required|string|max:50|unique:App\Models\HIS\LocationStore,location_store_code',
    ...
    {
        return [
            'location_store_code.required'    => config('keywords')['location_store']['location_store_code'].config('keywords')['error']['required'],
            'location_store_code.string'      => config('keywords')['location_store']['location_store_code'].config('keywords')['error']['string'],
            'location_store_code.max'         => config('keywords')['location_store']['location_store_code'].config('keywords')['error']['string_max'],
            'location_store_code.unique'      => config('keywords')['location_store']['location_store_code'].config('keywords')['error']['unique'],
