...
class UpdateTestIndexRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if(!is_numeric($this->test_index)){
            throw new HttpResponseException(returnIdError($this->test_index));
        }
        return [
            'test_index_code' =>        [
                                                    'required',
                                                    'string',
                                                    'max:20',
                                                    Rule::unique('App\Models\HIS\TestIndex')->ignore($this->test_index),
                                                ],
