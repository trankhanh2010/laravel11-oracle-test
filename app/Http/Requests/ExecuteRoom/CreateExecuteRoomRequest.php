...
class CreateExecuteRoomRequest extends FormRequest
{
    ...
    {
        return [
            'execute_room_code.required'    => config('keywords')['execute_room']['execute_room_code'].config('keywords')['error']['required'],
            'execute_room_code.string'      => config('keywords')['execute_room']['execute_room_code'].config('keywords')['error']['string'],
            'execute_room_code.max'         => config('keywords')['execute_room']['execute_room_code'].config('keywords')['error']['string_max'],
            'execute_room_code.unique'      => config('keywords')['execute_room']['execute_room_code'].config('keywords')['error']['unique'],
            ...
            'department_id.required'    => config('keywords')['execute_room']['department_id'].config('keywords')['error']['required'],            
            'department_id.integer'     => config('keywords')['execute_room']['department_id'].config('keywords')['error']['integer'],
            'department_id.exists'      => config('keywords')['execute_room']['department_id'].config('keywords')['error']['exists'],  
