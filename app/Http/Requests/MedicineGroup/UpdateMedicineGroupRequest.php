...
class UpdateMedicineGroupRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if(!is_numeric($this->medicine_group)){
            throw new HttpResponseException(returnIdError($this->medicine_group));
        }
        return [
            'medicine_group_code' =>        [
                                                    'required',
                                                    'string',
                                                    'max:4',
                                                    Rule::unique('App\Models\HIS\MedicineGroup')->ignore($this->medicine_group),
                                                ],
