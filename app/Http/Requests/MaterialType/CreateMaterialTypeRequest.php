...
class CreateMaterialTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'material_type_code' =>      'required|string|max:25|unique:App\Models\HIS\MaterialType,material_type_code',
    ...
    public function messages()
    {
        return [
            ...
            'material_type_name.required'    => config('keywords')['material_type']['material_type_name'].config('keywords')['error']['required'],
