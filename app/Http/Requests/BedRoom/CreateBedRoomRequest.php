...
class CreateBedRoomRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'area_id' => 'integer|max:22|exists:App\Models\HIS\Area,id',
            'speciality_id' => 'integer|max:22|exists:App\Models\HIS\Speciality,id',
            'default_cashier_room_id' => 'integer|max:22|exists:App\Models\HIS\CashierRoom,id',
            'default_instr_patient_type_id'  => 'integer|max:22|exists:App\Models\HIS\PatientType,id',
            'is_surgery'  => 'integer|max:22|in:0,1',
            'is_restrict_req_service' => 'integer|max:22|in:0,1',
            'is_pause' => 'integer|max:22|in:0,1',
            'is_restrict_execute_room' =>'integer|max:22|in:0,1',
        ];
    }
