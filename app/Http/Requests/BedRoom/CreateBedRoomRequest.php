...
class CreateBedRoomRequest extends FormRequest
{
    ...
    {
        return [
            'bed_room_code.required'    => config('keywords')['bed_room']['bed_room_code'].config('keywords')['error']['required'],
            'bed_room_code.string'      => config('keywords')['bed_room']['bed_room_code'].config('keywords')['error']['string'],
            'bed_room_code.max'         => config('keywords')['bed_room']['bed_room_code'].config('keywords')['error']['string_max'],            
            'bed_room_code.unique'      => config('keywords')['bed_room']['bed_room_code'].config('keywords')['error']['unique'],
            ...
            'department_id.required'    => config('keywords')['bed_room']['department_id'].config('keywords')['error']['required'],            
            'department_id.integer'     => config('keywords')['bed_room']['department_id'].config('keywords')['error']['integer'],
            'department_id.exists'      => config('keywords')['bed_room']['department_id'].config('keywords')['error']['exists'],  
