...
class CreateInteractionReasonRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'interaction_reason_code' =>      'required|string|max:10|unique:App\Models\HIS\InteractionReason,interaction_reason_code',
