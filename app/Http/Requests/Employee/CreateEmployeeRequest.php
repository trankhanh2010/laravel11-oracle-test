...
class CreateEmployeeRequest extends FormRequest
{
    ...
    {
        return [
            'loginname' =>          'required|string|max:50|unique:App\Models\HIS\Employee,loginname',
    ...
    {
        return [
            'loginname.required'    => config('keywords')['emp_user']['loginname'].config('keywords')['error']['required'],
            'loginname.string'      => config('keywords')['emp_user']['loginname'].config('keywords')['error']['string'],
            'loginname.max'         => config('keywords')['emp_user']['loginname'].config('keywords')['error']['string_max'],
            'loginname.unique'      => config('keywords')['emp_user']['loginname'].config('keywords')['error']['unique'],
