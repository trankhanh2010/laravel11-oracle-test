...
namespace App\Events\Elastic\Branch;
...
class CreateBranchIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-branch-create-index'),
        ];
    }
}
