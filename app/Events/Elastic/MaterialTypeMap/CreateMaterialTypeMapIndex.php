...
namespace App\Events\Elastic\MaterialTypeMap;
...
class CreateMaterialTypeMapIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-material-type-map-create-index'),
        ];
    }
}
