...
namespace App\Events\Elastic\Room;
...
class CreateRoomIndex
{
            ...
            'body' => [
                ...
                'mappings' => [
                    'properties' => [
                        ...
                        'is_auto_show_request' => [
                            'type' => 'byte'
                        ],
                        'is_use_kiosk' => [
                            'type' => 'byte'
                        ],
                        'is_restrict_medicine_type' => [
                            'type' => 'byte'
                        ],
    ...
    {
        return [
            new PrivateChannel('elastic-room-create-index'),
        ];
    }
}
