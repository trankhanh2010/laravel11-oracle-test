...
namespace App\Events\Elastic\TreatmentFeeView;
...
class CreateTreatmentFeeViewIndex
{
            ...
            'body' => [
                ...
                'mappings' => [
                    'properties' => [
                        ...
                        'sick_leave_day' => [
                            "type" => "scaled_float", // nhân giá trị gốc với 1000để giữ lại 2 chữ số thập phân. Chia lại cho 100 khi đọc dữ liệu.
                            "scaling_factor" => 100
                        ],      
                        'sick_leave_from' => [
                            'type' => 'date',  // Lưu trữ ngày giờ
                        ...
                        'tdl_patient_military_rank_name'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'is_creating_transaction' => [
                            'type' => 'byte'
                        ],     
                        'co_treat_department_ids'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'record_inspection_stt_id'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'record_inspection_reject_note'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'tdl_patient_cmnd_date'  => [
                            'type' => 'date',  // Lưu trữ ngày giờ
                            'format' => 'yyyyMMddHHmmss'
                        ],      
                        'tdl_patient_cmnd_place'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'tdl_patient_position_id'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],     
                        'is_bhyt_holded'  => [
                            'type' => 'byte'
                        ], 
                        'tdl_patient_passport_number'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'tdl_patient_passport_date'  => [
                            'type' => 'date',  // Lưu trữ ngày giờ
                            'format' => 'yyyyMMddHHmmss'
                        ],  
                        'tdl_patient_passport_place' => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'tran_pati_book_number'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'tran_pati_doctor_loginname'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'tran_pati_department_loginname'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
                        ...
                        'number_of_full_term_birth'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'number_of_premature_birth'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],    
                        ...
                        'is_early_newborn_care'  => [
                            'type' => 'byte'
                        ],
                        'newborn_care_at_home'  => [
                            'type' => 'byte'
                        ],
                        'test_hepatitis_b'  => [
                            'type' => 'byte'
                        ...
                        'total_bill_other_amount'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],    
                        'total_bill_transfer_amount'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],   
                        'total_bill_exemption'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ], 
                        'total_bill_fund'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ...
                        'total_patient_price_bhyt'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],   
                        'total_other_source_price'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],      
                        'last_deposit_time'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],      
                        'total_service_deposit_amount' => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'work_place_address'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                        ...
                        'dis_service_deposit_option'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],     
                        'is_dis_service_repay'  => [
                            'type' => 'byte'
                        ],    
                        'dis_deposit_option' => [
                            'type' => 'byte'
    ...
    {
        return [
            new PrivateChannel('elastic-treatment-fee-view-create-index'),
        ];
    }
}
