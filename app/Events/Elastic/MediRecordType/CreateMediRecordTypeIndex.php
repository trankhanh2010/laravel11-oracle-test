...
namespace App\Events\Elastic\MediRecordType;
...
class CreateMediRecordTypeIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-medi-record-type-create-index'),
        ];
    }
}
