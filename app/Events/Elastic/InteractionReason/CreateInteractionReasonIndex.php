...
namespace App\Events\Elastic\InteractionReason;
...
class CreateInteractionReasonIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-interaction-reason-create-index'),
        ];
    }
}
