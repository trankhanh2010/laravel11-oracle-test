...
namespace App\Events\Elastic\HospitalizeReason;
...
class CreateHospitalizeReasonIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-hospitalize-reason-create-index'),
        ];
    }
}
