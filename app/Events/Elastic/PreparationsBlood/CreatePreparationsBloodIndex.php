...
namespace App\Events\Elastic\PreparationsBlood;
...
class CreatePreparationsBloodIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-preparations-blood-create-index'),
        ];
    }
}
