...
namespace App\Events\Elastic\TestServiceReqListVView;
...
class CreateTestServiceReqListVViewIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-test-service-req-list-v-view-create-index'),
        ];
    }
}
