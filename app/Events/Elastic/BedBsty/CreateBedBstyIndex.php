...
namespace App\Events\Elastic\BedBsty;
...
class CreateBedBstyIndex
{
                ...
                'settings' => [
                    'analysis' => [
                        ...
                        'filter' => [
                            'my_stop_filter' => [
                                'type' => 'stop',
                                'stopwords' => ['giuong', 'khoa', 'khoa_phong', 'hang', 'loai'] // Danh sách từ dừng tùy chỉnh
                            ]
                        ]
                    ]
                ],
    ...
    {
        return [
            new PrivateChannel('elastic-bed-bsty-create-index'),
        ];
    }
}
