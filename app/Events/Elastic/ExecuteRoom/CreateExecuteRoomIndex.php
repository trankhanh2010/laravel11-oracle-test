...
namespace App\Events\Elastic\ExecuteRoom;
...
class CreateExecuteRoomIndex
{
            ...
            'body' => [
                ...
                'mappings' => [
                    'properties' => [
                        ...
                        'max_appointment_by_day' => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'is_test' => [
                            'type' => 'byte'
                        ],
                        'is_auto_expend_add_exam' => [
                            'type' => 'byte'
                        ],
                        'max_patient_by_day' => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'allow_not_choose_service' => [
                            'type' => 'byte'
                        ],
                        'department_code' => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
    ...
    {
        return [
            new PrivateChannel('elastic-execute-room-create-index'),
        ];
    }
}
