...
namespace App\Events\Elastic\ServiceFollow;
...
class CreateServiceFollowIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-service-follow-create-index'),
        ];
    }
}
