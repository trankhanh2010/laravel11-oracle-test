...
namespace App\Events\Elastic\Employee;
...
class CreateEmployeeIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-employee-create-index'),
        ];
    }
}
