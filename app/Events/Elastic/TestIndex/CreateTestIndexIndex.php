...
namespace App\Events\Elastic\TestIndex;
...
class CreateTestIndexIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-test-index-create-index'),
        ];
    }
}
