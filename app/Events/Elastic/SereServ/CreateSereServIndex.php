...
namespace App\Events\Elastic\SereServ;
...
class CreateSereServIndex
{
            ...
            'body' => [
                ...
                'mappings' => [
                    'properties' => [
                        ...
                        'tdl_carer_card_borrow_id'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'tdl_ration_time_id'  => [
                            'type' => 'long'  // Số nguyên 64-bit, phù hợp với ID số
                        ],
                        'is_confirm_no_excute' => [
                            'type' => 'byte'
                        ],
                        'confirm_no_excute_reason'  => [
                            'type' => 'text',  // Văn bản phân tích, hỗ trợ tìm kiếm full-text
                            'analyzer' => 'my_custom_analyzer', // Sử dụng analyzer tùy chỉnh
                            'fields' => [
                                'keyword' => [  // Phân tích không để sắp xếp và tìm kiếm chính xác
    ...
    {
        return [
            new PrivateChannel('elastic-sere-serv-create-index'),
        ];
    }
}
