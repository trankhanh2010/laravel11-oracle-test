...
namespace App\Events\Elastic\OtherPaySource;
...
class CreateOtherPaySourceIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-other-pay-source-create-index'),
        ];
    }
}
