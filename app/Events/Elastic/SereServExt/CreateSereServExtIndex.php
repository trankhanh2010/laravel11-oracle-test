...
namespace App\Events\Elastic\SereServExt;
...
class CreateSereServExtIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-sere-serv-ext-create-index'),
        ];
    }
}
