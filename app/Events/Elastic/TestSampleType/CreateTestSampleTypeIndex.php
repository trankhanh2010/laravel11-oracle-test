...
namespace App\Events\Elastic\TestSampleType;
...
class CreateTestSampleTypeIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-test-sample-type-create-index'),
        ];
    }
}
