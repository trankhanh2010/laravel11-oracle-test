...
namespace App\Events\Elastic\SereServTeinVView;
...
class CreateSereServTeinVViewIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-sere-serv-tein-v-view-create-index'),
        ];
    }
}
