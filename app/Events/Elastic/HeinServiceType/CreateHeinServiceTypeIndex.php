...
namespace App\Events\Elastic\HeinServiceType;
...
class CreateHeinServiceTypeIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-hein-service-type-create-index'),
        ];
    }
}
