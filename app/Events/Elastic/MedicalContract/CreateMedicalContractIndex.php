...
namespace App\Events\Elastic\MedicalContract;
...
class CreateMedicalContractIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-medical-contract-create-index'),
        ];
    }
}
