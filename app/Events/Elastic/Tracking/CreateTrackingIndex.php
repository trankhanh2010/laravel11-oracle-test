...
namespace App\Events\Elastic\Tracking;
...
class CreateTrackingIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-tracking-create-index'),
        ];
    }
}
