...
namespace App\Events\Elastic\MedicineGroup;
...
class CreateMedicineGroupIndex
{
            ...
            'body' => [
                ...
                'mappings' => [
                    'properties' => [
                        ...
                        'is_separate_printing' => [
                            'type' => 'byte'
                        ],
                        'is_numbered_tracking' => [
                            'type' => 'byte'
                        ],
                        'is_warning' => [
                            'type' => 'byte'
    ...
    {
        return [
            new PrivateChannel('elastic-medicine-group-create-index'),
        ];
    }
}
