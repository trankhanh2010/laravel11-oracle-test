...
namespace App\Events\Elastic\SeseDepoRepayVView;
...
class CreateSeseDepoRepayVViewIndex
{
    ...
    {
        return [
            new PrivateChannel('elastic-sese-depo-repay-v-view-create-index'),
        ];
    }
}
