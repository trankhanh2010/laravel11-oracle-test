...
class BhytWhitelistRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_bhyt_whitelist.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_bhyt_whitelist.id');
            $maxId = $this->applyJoins()->max('his_bhyt_whitelist.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('bhyt_whitelist', 'his_bhyt_whitelist', $startId, $endId, $batchSize);
            }
        }
    }
}