...
class ReligionRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('sda_religion.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('sda_religion.id');
            $maxId = $this->applyJoins()->max('sda_religion.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('religion', 'sda_religion', $startId, $endId, $batchSize);
            }
        }
    }
}