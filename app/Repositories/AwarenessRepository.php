...
class AwarenessRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_awareness.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_awareness.id');
            $maxId = $this->applyJoins()->max('his_awareness.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('awareness', 'his_awareness', $startId, $endId, $batchSize);
            }
        }
    }
}