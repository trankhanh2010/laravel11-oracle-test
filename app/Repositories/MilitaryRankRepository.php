...
class MilitaryRankRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_military_rank.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_military_rank.id');
            $maxId = $this->applyJoins()->max('his_military_rank.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('military_rank', 'his_military_rank', $startId, $endId, $batchSize);
            }
        }
    }
}