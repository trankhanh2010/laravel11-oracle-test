...
class RoomRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_room.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_room.id');
            $maxId = $this->applyJoins()->max('his_room.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('room', 'his_room', $startId, $endId, $batchSize);
            }
        }
    }
}
