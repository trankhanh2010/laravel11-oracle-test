...
class BedBstyRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_bed_bsty.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_bed_bsty.id');
            $maxId = $this->applyJoins()->max('his_bed_bsty.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('bed_bsty', 'his_bed_bsty', $startId, $endId, $batchSize);
            }
        }
    }
}