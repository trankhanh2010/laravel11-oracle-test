...
class DebateTypeRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_debate_type.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_debate_type.id');
            $maxId = $this->applyJoins()->max('his_debate_type.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('debate_type', 'his_debate_type', $startId, $endId, $batchSize);
            }
        }
    }
}