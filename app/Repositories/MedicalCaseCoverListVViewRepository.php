...
class MedicalCaseCoverListVViewRepository
{
    ...
    public function __construct(
        MedicalCaseCoverListVView $medicalCaseCoverListVView,
        ...
        if ($tab == 'info') {
            return $this->medicalCaseCoverListVView
                ->select([
                    ...
                    'in_department_code',
                    'in_department_name',
                    'in_department_bhyt_code',
                    'last_department_code',
                    'last_department_name',
                    'last_department_bhyt_code',
                    'end_department_code',
                    'end_department_name',
                    'end_department_bhyt_code',
                    'exit_department_code',
                    'exit_department_name',
                    'exit_department_bhyt_code',
                    'hospitalize_department_code',
                    'hospitalize_department_name',
                    'bed_id',
                    'in_time',
                    'in_date',
                    'clinical_in_time',
    ...
    public function applyJoinsYeuCauKhamClsPttt()
    {
        return $this->medicalCaseCoverListVView
            ->select([
                'id',
    ...
    {
        $dataFee = $this->treatmentFeeDetailVView->find($item->id);
        ...
        $tongChiPhi = isset($dataFee->total_price) ? $dataFee->total_price : null;
