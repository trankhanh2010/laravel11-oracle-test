...
class MedicineTypeRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_medicine_type.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_medicine_type.id');
            $maxId = $this->applyJoins()->max('his_medicine_type.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('medicine_type', 'his_medicine_type', $startId, $endId, $batchSize);
            }
        }
    }
}
