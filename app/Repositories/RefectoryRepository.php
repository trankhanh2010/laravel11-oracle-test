...
class RefectoryRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_refectory.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_refectory.id');
            $maxId = $this->applyJoins()->max('his_refectory.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('refectory', 'his_refectory', $startId, $endId, $batchSize);
            }
        }
    }
}
