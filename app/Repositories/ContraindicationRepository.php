...
class ContraindicationRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_contraindication.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_contraindication.id');
            $maxId = $this->applyJoins()->max('his_contraindication.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('contraindication', 'his_contraindication', $startId, $endId, $batchSize);
            }
        }
    }
}