...
class IcdListVViewRepository
{
    protected $icdListVView;
    public function __construct(IcdListVView $icdListVView)
    {
    ...
    {
        return $this->icdListVView->find($id);
    }
    // public function create($request, $time, $appCreator, $appModifier){
    //     $data = $this->icdListVView::create([
    ...
    //         'is_active' => 1,
    //         'is_delete' => 0,
    //         'icd_list_v_view_code' => $request->icd_list_v_view_code,
    //         'icd_list_v_view_name' => $request->icd_list_v_view_name,
    //     ]);
    //     return $data;
    // }
