...
class AtcGroupRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_atc_group.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_atc_group.id');
            $maxId = $this->applyJoins()->max('his_atc_group.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('atc_group', 'his_atc_group', $startId, $endId, $batchSize);
            }
        }
    }
}