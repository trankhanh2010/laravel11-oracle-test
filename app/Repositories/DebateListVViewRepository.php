...
class DebateListVViewRepository
{
    protected $debateListVView;
    public function __construct(DebateListVView $debateListVView)
    {
    ...
    {
        return $this->debateListVView->find($id);
    }
    // public function create($request, $time, $appCreator, $appModifier){
    //     $data = $this->debateListVView::create([
    ...
    //         'is_active' => 1,
    //         'is_delete' => 0,
    //         'debate_list_v_view_code' => $request->debate_list_v_view_code,
    //         'debate_list_v_view_name' => $request->debate_list_v_view_name,
    //     ]);
    //     return $data;
    // }
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('debate_list_v_view', 'v_his_debate_list', $startId, $endId, $batchSize);
            }
        }
    }
}