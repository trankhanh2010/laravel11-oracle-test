...
class AccidentLocationRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_accident_location.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_accident_location.id');
            $maxId = $this->applyJoins()->max('his_accident_location.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('accident_location', 'his_accident_location', $startId, $endId, $batchSize);
            }
        }
    }
}
