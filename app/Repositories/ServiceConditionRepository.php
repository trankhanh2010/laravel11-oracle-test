...
class ServiceConditionRepository
{
    ...
    public function getDataFromDbToElastic($batchSize = 5000, $id = null)
    {
        ...
        if ($id != null) {
            $data = $this->applyJoins()->where('his_service_condition.id', '=', $id)->first();
            if ($data) {
            ...
            $minId = $this->applyJoins()->min('his_service_condition.id');
            $maxId = $this->applyJoins()->max('his_service_condition.id');
            ...
            for ($i = 0; $i < $numJobs; $i++) {
                ...
                ProcessElasticIndexingJob::dispatch('service_condition', 'his_service_condition', $startId, $endId, $batchSize);
            }
        }
    }
}