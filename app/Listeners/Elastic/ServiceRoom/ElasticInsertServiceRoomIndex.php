...
class ElasticInsertServiceRoomIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertServiceRoomIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(ServiceRoomRepository::class)->getDataFromDbToElastic(null, $record->id);
