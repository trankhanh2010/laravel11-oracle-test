...
namespace App\Listeners\Elastic\Employee;
...
class ElasticInsertEmployeeIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertEmployeeIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(EmployeeRepository::class)->getDataFromDbToElastic(null, $record->id);
