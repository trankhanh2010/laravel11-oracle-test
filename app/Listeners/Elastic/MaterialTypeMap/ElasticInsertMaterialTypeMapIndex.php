...
namespace App\Listeners\Elastic\MaterialTypeMap;
...
class ElasticInsertMaterialTypeMapIndex
{
    /**
    ...
    public function handle(InsertMaterialTypeMapIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(MaterialTypeMapRepository::class)->getDataFromDbToElastic(null, $record->id);
