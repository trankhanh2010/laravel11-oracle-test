...
class ElasticInsertBidTypeIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertBidTypeIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(BidTypeRepository::class)->getDataFromDbToElastic(null, $record->id);
