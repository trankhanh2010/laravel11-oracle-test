...
class ElasticInsertDebateVViewIndex
{
    ...
    public function handle(InsertDebateVViewIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(DebateVViewRepository::class)->getDataFromDbToElastic(null, $record->id);
