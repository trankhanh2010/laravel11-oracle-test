...
class ElasticInsertBodyPartIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertBodyPartIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(BodyPartRepository::class)->getDataFromDbToElastic(null, $record->id);
