...
class ElasticInsertAgeTypeIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertAgeTypeIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(AgeTypeRepository::class)->getDataFromDbToElastic(null, $record->id);
