...
class ElasticInsertMedicinePatyIndex
{
    /**
     ...
     * Handle the event.
     */
    public function handle(InsertMedicinePatyIndex $event): void
    {
        try {
            ...
            $record = $event->record;
            $data = app(MedicinePatyRepository::class)->getDataFromDbToElastic(null, $record->id);
