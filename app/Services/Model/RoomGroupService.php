...
class RoomGroupService 
{
    ...
    {
        try {
            $cacheKey = $this->params->roomGroupName .'_'. $this->params->param;
            $cacheKeySet = "cache_keys:" . $this->params->roomGroupName; // Set để lưu danh sách key
    ...
    {
        try {
            $cacheKey = $this->params->roomGroupName .'_'.$id.'_'. $this->params->param;
            $cacheKeySet = "cache_keys:" . $this->params->roomGroupName; // Set để lưu danh sách key
