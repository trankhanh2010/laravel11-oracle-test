...
class TestIndexService 
{
    ...
    {
        try {
            $cacheKey = $this->params->testIndexName .'_'. $this->params->param;
            $cacheKeySet = "cache_keys:" . $this->params->testIndexName; // Set để lưu danh sách key
    ...
    {
        try {
            $cacheKey = $this->params->testIndexName .'_'.$id.'_'. $this->params->param;
            $cacheKeySet = "cache_keys:" . $this->params->testIndexName; // Set để lưu danh sách key
