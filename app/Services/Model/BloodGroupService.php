    ...
    public function handleDataBaseGetAll()
    {
        try {
            ...
            if ($this->params->noCache) {
                ...
                $cacheKey = $this->params->bloodGroupName . '_' . $this->params->param;
                $cacheKeySet = "cache_keys:" . $this->params->bloodGroupName; // Set để lưu danh sách key
    ...
    public function handleDataBaseGetWithId($id)
    {
        try {
            ...
            if ($this->params->noCache) {
                ...
                $cacheKey = $this->params->bloodGroupName . '_' . $id . '_' . $this->params->param;
                $cacheKeySet = "cache_keys:" . $this->params->bloodGroupName; // Set để lưu danh sách key
