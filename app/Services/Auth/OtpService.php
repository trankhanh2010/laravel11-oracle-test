...
class OtpService
{
    ...
    public function setLastOtpSentTo($value){
    ...
    public function createAndSendOtpPhoneTreatmentFee()
    {
        ...
        try {
            ...
            $this->setLastOtpSentTo($this->phone); // set nơi nhận otp cuối
            return true;
        } catch (\Throwable $e) {
            return false;
        }
    ...
    public function createAndSendOtpMobileTreatmentFee()
    {
        ...
        try {
            ...
            // Gửi thành công thì mới tạo cache
            $this->createCacheSaveOtp();
            $this->setLastOtpSentTo($this->mobile); // set nơi nhận otp cuối
            return true;
        } catch (\Throwable $e) {
            return false;
        }
    ...
    public function createAndSendOtpPatientRelativePhoneTreatmentFee()
    {
        ...
        try {
            ...
            // Gửi thành công thì mới tạo cache
            $this->createCacheSaveOtp();
            $this->setLastOtpSentTo($this->relativePhone); // set nơi nhận otp cuối
            return true;
        } catch (\Throwable $e) {
            return false;
        }
    ...
    public function createAndSendOtpPatientRelativeMobileTreatmentFee()
    {
        ...
        try {
            ...
            // Gửi thành công thì mới tạo cache
            $this->createCacheSaveOtp();
            $this->setLastOtpSentTo($this->relativeMobile); // set nơi nhận otp cuối
            return true;
        } catch (\Throwable $e) {
            return false;
        }
    ...
    public function createAndSendOtpMailTreatmentFee()
    {
        ...
        try {
            ...
            // Gửi thành công thì mới tạo cache
            $this->createCacheSaveOtp();
            $this->setLastOtpSentTo($this->email); // set nơi nhận otp cuối
            return true;
        } catch (\Throwable $e) {
            return false;
        }
